...
<div class="box">
        ...
        <thead>
          ...
          <tr>
             ...
             <td><a href="{{url('order-detail/'.$order->id)}}" title="Order Detail">{{ $order->ordernumber!=''?$order->ordernumber:$order->ecom_externalid_c__c}}</a></td>
              <td >
              @if(count($order->summary))
              <ul>
              @foreach($order->summary as $summary)
                @if($summary['product_name']!='Shipping cost')
                <li><a href="{{url('products/details/'.$summary['product_id'])}}" title="Detail">{{$summary['product_name']}} ({{$summary['quantity']}})</a></li>
                @endif
              @endforeach
              </ul>
              @endif
        ...
        @else
        <p>No Orders. Go to <a href="{{URL::route('products')}}">Products Page</a></p>
        @endif
    </div>
</div>
<header class="page-header">
                ...
                <div class="col-lg-6">
                    ...
                    <span class="input-group-addon">
                        ...
                        <input type="text" placeholder=" " name="first_name" id="u-name"
                               class="form-control" disabled="disabled" value="{!! old('first_name',$user->first_name) !!}">
                    </div>
            ...
            <div class="form-group {{ $errors->first('last_name', 'has-error') }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input type="text" disabled="disabled" placeholder=" " name="last_name" id="u-name"
                               class="form-control"
            ...
            <div class="form-group {{ $errors->first('email', 'has-error') }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input disabled="disabled" type="text" placeholder=" " id="email" name="email" class="form-control"
