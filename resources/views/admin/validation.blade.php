                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" id="form-validation1" action="#" method="patch">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="button-checkbox">
                                                        ...
                                                        <input type="checkbox" name="terms" id="chkterms" class="hidden" value="1"></span>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <p class="margin-top">
                                                            By clicking on the
                                                ...
                                                <div class="row marginTop">
                                                    <div class="col-xs-6 col-md-6">
                                                        <input type="submit" id="btncheck" value="Register" class="btn btn-primary btn-block btn-md btn-responsive" tabindex="7"></div>
                                                    <div class="col-xs-6 col-md-6">
